...
clean_df <- raw_df[!grepl("2017-06", raw_df$timeStart), ] # My code has a risk (logical -> character) Use Alternative way(clean_df <- subset(raw_df, raw_df$timeStart >= "2017-06-01 00:00:00"))
...
sum((clean_df$q1 >= clean_df$q2) & (clean_df$q2 != clean_df$q3)) # note: think about true & true process
